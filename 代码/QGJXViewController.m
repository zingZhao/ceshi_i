...
@interface QGJXViewController ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation QGJXViewController
...
-(void)getData{
    ...
    [self getDataSource:[NSString stringWithFormat:@"%@%@",URL_url,URL_list_job] Params:@{@"page":[NSString stringWithFormat:@"%ld",page],@"type":@"2"} success:^(NSDictionary *json) {
...
- (void)setupRefresh
{
    __weak QGJXViewController *weakSelf = self;
