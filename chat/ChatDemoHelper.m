...
{
    [self _clearHelper];
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"提示" message:@"您的账号已在别处登录" delegate:self cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
    [alertView show];
...
{
    [self _clearHelper];
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"提示" message:@"您的账号已被管理员删除" delegate:self cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
    [alertView show];
    [[NSNotificationCenter defaultCenter] postNotificationName:KNOTIFICATION_LOGINCHANGE object:@NO];
}
    ...
    for(EMMessage *message in aMessages){
        ...
        if (needShowNotification) {
            ...
            switch (state) {
                ...
                {
                    [[NSNotificationCenter defaultCenter]postNotificationName:@"locon" object:nil userInfo:@{@"mes":message}];
                }
                    break;
                ...
                {
                    [[NSNotificationCenter defaultCenter]postNotificationName:@"loc" object:nil userInfo:@{@"mes":message}];
                }
                    break;
                default:
                    break;
               ...
               message:(NSString *)aMessage
{
    ...
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"提示" message:[NSString stringWithFormat:@"管理员邀请您加入群组：%@", tit] delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
    [alertView show];
}
