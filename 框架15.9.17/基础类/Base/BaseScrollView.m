...
//                  animated:YES];
//    CGFloat hig = [self idealOffsetForView:firstResponder withSpace:[self keyboardRect].origin.y - self.bounds.origin.y];
//
...
-(CGFloat)idealOffsetForView:(UIView *)view withSpace:(CGFloat)space {
    ...
    if ( self.contentSize.height - offset < space ) {
        ...
        offset = space + offset - self.contentSize.height;
    } else {
